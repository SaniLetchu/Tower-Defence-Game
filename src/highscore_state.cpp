...
void Highscorestate::initHighscores() {
	...
	text.setPosition(sf::Vector2f(0.4*windowX_, 20));
...
void Highscorestate::initButtons()
{
	...
	// Add buttons
	this->highscroeButtons_["BACK"] = new Button(this->windowX_*0.4, 3.75*this->windowY_, 300, 150, this->font_, "Back", sf::Color(100, 100, 100, 200), sf::Color(150, 150, 150, 255), sf::Color(20, 20, 20, 200), 60, true);
}
